...
typedef struct TGenericSeq TGenericSeq, *PTGenericSeq;
...
typedef struct NimStringDesc8 NimStringDesc8, *PNimStringDesc8;

struct NimStringDesc8 {
    struct TGenericSeq Sup;
    char data[9];
};

typedef struct NimStringDesc18 NimStringDesc18, *PNimStringDesc18;

struct NimStringDesc18 {
    struct TGenericSeq Sup;
    char data[19];
};

typedef struct NimStringDesc0 NimStringDesc0, *PNimStringDesc0;

struct NimStringDesc0 {
    struct TGenericSeq Sup;
    char data[1];
};

typedef struct NimStringDesc11 NimStringDesc11, *PNimStringDesc11;

struct NimStringDesc11 {
    struct TGenericSeq Sup;
    char data[12];
};

typedef struct NimStringDesc43 NimStringDesc43, *PNimStringDesc43;

struct NimStringDesc43 {
    struct TGenericSeq Sup;
    char data[44];
};

typedef struct NimStringDesc10 NimStringDesc10, *PNimStringDesc10;

struct NimStringDesc10 {
    struct TGenericSeq Sup;
    char data[11];
};
...

{
  ...
  if (unaff_R12 != 0) {
    Nim::system::rawDealloc(*in_FS_OFFSET + -0x3300);
  }
...
void Nim::system::add_cold(void)

{
  code *pcVar1;
  long *in_FS_OFFSET;
  
  rawDealloc(*in_FS_OFFSET + -0x3300);
  _DAT_00000000 = 0;
                    // WARNING: Does not return
  pcVar1 = (code *)invalidInstructionException();
  (*pcVar1)();
...

{
  ...
  cmdLine = param_2;
  cmdCount = param_1;
  Nim::..::..::..::..::..::.choosenim::toolchains::nim-2.2.4::lib::system::Init000();
  Nim::pokerod::main();
  nimTestErrorFlag();
...
void Nim::system::_trace(long param_1,long *param_2)
...
void Nim::std::syncio::_trace(long param_1,long *param_2)
...
void Nim::system::exceptions::rttiDestroy(long param_1)

{
  ...
  if (puVar1 != (undefined8 *)0x0) {
    uVar2 = puVar1[-2];
    if (uVar2 < 0x10) {
      rememberCycle(1,puVar1 + -2,*puVar1);
      ...
      puVar1[-2] = uVar2 - 0x10;
      rememberCycle(0,puVar1 + -2,*puVar1);
    }
  }
  ...
  std::assertions::_destroy(*(undefined8 *)(param_1 + 0x28),*(undefined8 *)(param_1 + 0x30));
...
void Nim::system::_destroy(long param_1)
...
void Nim::std::syncio::_destroy(long param_1)

{
  ...
  if (puVar1 != (undefined8 *)0x0) {
    uVar2 = puVar1[-2];
    if (uVar2 < 0x10) {
      system::rememberCycle(1,puVar1 + -2,*puVar1);
      nimDestroyAndDispose(*(undefined8 *)(param_1 + 8));
    }
    else if (SBORROW8(uVar2,0x10)) {
      raiseOverflow();
      ...
      puVar1[-2] = uVar2 - 0x10;
      system::rememberCycle(0,puVar1 + -2,*puVar1);
    }
  }
  if ((*(long *)(param_1 + 0x20) != 0) && ((*(byte *)(*(long *)(param_1 + 0x20) + 7) & 0x40) == 0))
  {
  ...
  assertions::_destroy(*(undefined8 *)(param_1 + 0x28),*(undefined8 *)(param_1 + 0x30));
  puVar1 = *(undefined8 **)(param_1 + 0x38);
  if (puVar1 == (undefined8 *)0x0) {
    return;
  }
...
void Nim::std::private::digitsutils::addInt(long *param_1,ulong param_2)
...
undefined1  [16] Nim::system::dollars::_(undefined8 param_1)

{
  undefined1 auVar1 [16];
  undefined8 local_18;
  NimStringDesc0 *local_10;
  
  local_10 = &ns_;
  local_18 = 0;
  std::private::digitsutils::addInt(&local_18,param_1);
...
undefined1  [16] Nim::system::dollars::_(int param_1)

{
  ...
  local_10 = &ns_;
  local_18 = 0;
  std::private::digitsutils::addInt(&local_18,(long)param_1);
  auVar1._8_8_ = local_10;
  auVar1._0_8_ = local_18;
  return auVar1;
}
...
void Nim::std::syncio::raiseEIO(undefined8 param_1,undefined8 param_2)

{
  ...
  *puVar1 = NTIv2__5a9aamn6nGq9cP9bHdfdhqobw_;
  auVar2 = system::_dup(param_1,param_2);
  puVar1[1] = 0;
...
void Nim::std::syncio::checkErr(FILE *param_1)

{
  ...
  if (iVar2 != 0) {
    ...
    auVar10 = system::dollars::_(*piVar3);
    lVar6 = auVar10._8_8_;
    __n = auVar10._0_8_;
...
byte Nim::std::syncio::readLine(FILE *param_1,size_t *param_2)
  ...
  do {
    ...
    while( true ) {
      ...
      if ((sVar2 != 0) && ((*(byte *)(sVar2 + 7) & 0x40) != 0)) {
        system::nimPrepareStrMutationImpl(param_2);
        sVar2 = param_2[1];
      }
      sVar7 = sVar7 + 1;
...
void Nim::std::syncio::raiseEOF(void)
...
undefined1  [16] Nim::std::syncio::readLine(undefined8 param_1)

{
  ...
  cVar1 = readLine(param_1,local_18);
...
void Nim::system::raiseOutOfMem(void)
...
void Nim::system::allocPages(undefined8 param_1,size_t param_2)
...
void * Nim::system::tryAllocPages(undefined8 param_1,size_t param_2)
...
void Nim::system::llAlloc(long param_1,size_t param_2)
...
void Nim::system::addHeapLink(long param_1,long param_2,long param_3)

{
  ...
  puVar3 = (undefined8 *)llAlloc(param_1,0x1f0);
...
void Nim::system::intSetGet(long param_1,ulong param_2)
...
uint Nim::system::contains(long param_1,long param_2)
...
ulong * Nim::system::requestOsChunks(long param_1,ulong param_2)
...
LAB_00103a73:
  ...
  *(long *)(param_1 + 0x2880) = *(long *)(param_1 + 0x2880) + param_2;
  ...
  puVar4 = (undefined8 *)llAlloc(param_1,0x1f0);
...
void Nim::system::intSetPut(undefined8 param_1,long param_2,ulong param_3)

{
  ...
  while( true ) {
    if (puVar2 == (undefined8 *)0x0) {
      puVar2 = (undefined8 *)llAlloc(param_1,0x50);
      *puVar2 = *puVar1;
      *puVar1 = puVar2;
      puVar2[1] = param_3;
      return;
...
void Nim::system::incl(undefined8 param_1,long param_2,long param_3)
...
long * Nim::system::splitChunk2(long param_1,long param_2,long param_3)

{
  ...
  *(long *)(param_2 + 8) = param_3;
  ...
  puVar3 = (undefined8 *)llAlloc(param_1,0x50);
...
void Nim::system::addChunkToMatrix(long param_1,long param_2)
...
void Nim::system::splitChunk(long param_1)
...
void Nim::system::removeChunkFromMatrix2(long param_1,long param_2,long param_3,long param_4)
...
undefined8 * Nim::system::getBigChunk(long param_1,long param_2)
    ...
    if (puVar6 != (undefined8 *)0x0) {
      ...
      *(undefined1 (*) [16])(puVar6 + 3) = (undefined1  [16])0x0;
      if ((long)(uVar3 + 0xfff) < (long)puVar6[1]) {
        uVar4 = splitChunk2(param_1,puVar6,uVar3);
        addChunkToMatrix(param_1,uVar4);
      }
      goto LAB_00104105;
    }
  }
  if ((long)uVar10 < 0x80000) {
    puVar6 = (undefined8 *)requestOsChunks(param_1,0x80000);
  }
  else {
    puVar6 = (undefined8 *)requestOsChunks(param_1,uVar3);
...
LAB_00104105:
  *puVar6 = 1;
  ...
  puVar5 = (undefined8 *)llAlloc(param_1,0x50);
...
void Nim::system::getSmallChunk(undefined8 param_1)

{
  getBigChunk(param_1,0x1000);
  return;
}



void Nim::system::compensateCounters(long param_1,ulong param_2,long param_3)
...
void Nim::system::excl(long param_1,long param_2)
...
void Nim::system::freeHugeChunk(long param_1,void *param_2)
...
void Nim::system::removeChunkFromMatrix(long param_1,long param_2)
...
void Nim::system::freeBigChunk(long param_1,ulong *param_2)
    ...
    for (puVar1 = *(undefined8 **)(param_1 + 0x28a0 + ((long)puVar11 >> 0x15 & 0xffU) * 8);
      ...
      if (puVar1[1] == (long)puVar11 >> 0x15) {
        ...
        if (((((ulong)puVar1[((long)uVar2 >> 6) + 2] >> (uVar2 & 0x3f) & 1) != 0) &&
          ...
          removeChunkFromMatrix(param_1,puVar11);
  ...
  for (puVar1 = *(undefined8 **)(param_1 + 0x28a0 + uVar10 * 8); puVar1 != (undefined8 *)0x0;
    ...
    if (uVar8 == puVar1[1]) {
      ...
      if (((((ulong)puVar1[lVar12] >> (uVar7 & 0x3f) & 1) != 0) && ((*pbVar9 & 1) == 0)) &&
        ...
        removeChunkFromMatrix(param_1,pbVar9);
...
LAB_001046f7:
  addChunkToMatrix(param_1,puVar11);
  return;
joined_r0x0010473e:
...
LAB_00104787:
  if (0x3f000000 < (long)uVar2) {
    puVar4 = (ulong *)splitChunk2(param_1,puVar11,0x3f000000);
    addChunkToMatrix(param_1,puVar11);
    uVar2 = puVar4[1];
    puVar11 = puVar4;
  }
...
LAB_001046d3:
  if (0x3f000000 < (long)uVar2) {
    uVar3 = splitChunk2(param_1,puVar11,0x3f000000);
    addChunkToMatrix(param_1,uVar3);
  }
  goto LAB_001046f7;
}
...
void Nim::system::deallocBigChunk(long param_1,void *param_2)
...
void Nim::system::freeDeferredObjects(long param_1,void *param_2)
...
undefined8 * Nim::system::getHugeChunk(long param_1,size_t param_2)
...
long * Nim::system::rawAlloc(long param_1,long param_2)

{
  ...
  if ((long)uVar10 < 0xfc1) {
    ...
    iVar3 = (int)uVar10;
    if (uVar6 == 0) {
      uVar6 = getBigChunk(param_1,0x1000);
...
long * Nim::system::alloc(long param_1,long param_2)
...
long * Nim::system::allocImpl(long param_1)

{
  ...
  if (0xfc0 < (long)uVar9) {
    ...
    *plVar6 = 0;
    ...
    if (param_1 + 0x30 < 0x3f000001) {
      lVar7 = getBigChunk(lVar2 + -0x3300);
    }
    else {
      lVar7 = getHugeChunk();
    }
  ...
  if (uVar4 == 0) {
    lVar7 = *in_FS_OFFSET;
    uVar4 = getBigChunk(lVar7 + -0x3300,0x1000);
...

{
  ...
  if (0xfc0 < (long)uVar9) {
    ...
    *plVar6 = 0;
    UNLOCK();
    if (lVar7 != 0) {
      Nim::system::freeDeferredObjects();
    }
    if (param_1 + 0x30 < 0x3f000001) {
      lVar7 = Nim::system::getBigChunk(lVar2 + -0x3300);
    }
    else {
      lVar7 = Nim::system::getHugeChunk();
    }
    plVar6 = (long *)(lVar7 + 0x30);
    lVar7 = *(long *)(lVar7 + 8) + in_FS_OFFSET[-0x14f];
    goto LAB_00105438;
  ...
  if (uVar4 == 0) {
    lVar7 = *in_FS_OFFSET;
    uVar4 = Nim::system::getBigChunk(lVar7 + -0x3300,0x1000);
    *(undefined8 *)(uVar4 + 0x28) = 0;
    *(int *)(uVar4 + 0x30) = 0xfc0 - iVar1;
    *(undefined8 *)(uVar4 + 0x38) = 0;
    *(ulong *)(uVar4 + 8) = uVar9;
...
void Nim::system::allocShared0Impl(size_t param_1)

{
  ...
  if (0xfc0 < (long)uVar8) {
    ...
    *plVar5 = 0;
    ...
    if ((long)(param_1 + 0x30) < 0x3f000001) {
      lVar4 = getBigChunk(lVar9 + -0x3300);
    }
    else {
      lVar4 = getHugeChunk();
    }
  ...
  if (uVar3 == 0) {
    lVar4 = *in_FS_OFFSET;
    uVar3 = getBigChunk(lVar4 + -0x3300);
...
long Nim::system::ptrSize(ulong param_1)
...
void Nim::system::rawDealloc(long param_1,long *param_2)
...
void Nim::system::dealloc(long param_1,long *param_2)
...
void * Nim::system::realloc(undefined8 param_1,void *param_2,size_t param_3)

{
  ...
  if (0 < (long)param_3) {
    __dest = (void *)rawAlloc(param_1,param_3);
    if (param_2 != (void *)0x0) {
...
void * Nim::system::reallocImpl(void *param_1,size_t param_2)

{
  ...
  if (0 < (long)param_2) {
    lVar1 = *in_FS_OFFSET;
    __dest = (void *)rawAlloc(lVar1 + -0x3300);
    if (param_1 != (void *)0x0) {
      ...
      rawDealloc(lVar1 + -0x3300,param_1);
    }
    return __dest;
  }
  if (param_1 != (void *)0x0) {
    rawDealloc(*in_FS_OFFSET + -0x3300,param_1);
  }
  return (void *)0x0;
}
...
void * Nim::system::reallocSharedImpl(void *param_1,size_t param_2)
...
void Nim::system::deallocImpl(long *param_1)
    ...
    if (lVar7 == lVar3 + -0x3300) {
      ...
      *(int *)((long)__addr + 0x30) = iVar10;
      if ((iVar10 == 0xfc0) && (*(long *)((long)__addr + 0x38) == 0)) {
        ...
        *(undefined8 *)((long)__addr + 8) = 0x1000;
        *(undefined1 (*) [16])((long)__addr + 0x18) = (undefined1  [16])0x0;
        freeBigChunk(lVar3 + -0x3300,__addr);
        return;
      }
    }
    else {
...
void Nim::system::deallocSharedImpl(long *param_1)
...

{
  ...
  if (lVar6 < 0xfc1) {
    ...
    if (lVar7 == lVar3 + -0x3300) {
      ...
      *(int *)((long)__addr + 0x30) = iVar10;
      if ((iVar10 == 0xfc0) && (*(long *)((long)__addr + 0x38) == 0)) {
        ...
        *(undefined8 *)((long)__addr + 8) = 0x1000;
        *(undefined1 (*) [16])((long)__addr + 0x18) = (undefined1  [16])0x0;
        Nim::system::freeBigChunk(lVar3 + -0x3300,__addr);
        return;
      }
    }
    else {
    ...
    if (lVar7 == *in_FS_OFFSET + -0x3300) {
      ...
      __len = *(size_t *)((long)__addr + 8);
      if ((long)__len < 0x3f000001) {
        Nim::system::freeBigChunk(lVar7,__addr);
        return;
      }
      puVar5 = (undefined8 *)in_FS_OFFSET[((long)param_1 >> 0x15 & 0xffU) - 0x14c];
      do {
...
void Nim::system::deinit(undefined1 (*param_1) [16])
          ...
          if (*(int *)((long)__addr + 0x30) < lVar7) {
            ...
            *(int *)((long)__addr + 0x30) = iVar11;
            if ((iVar11 == 0xfc0) && (*(long *)((long)__addr + 0x38) == 0)) {
              ...
              *(undefined8 *)((long)__addr + 8) = 0x1000;
              *(undefined1 (*) [16])((long)__addr + 0x18) = (undefined1  [16])0x0;
              freeBigChunk(lVar4 + -0x3300,__addr);
            }
          }
        }
        else {
...
void Nim::std::assertions::_destroy(undefined8 param_1,long param_2)

{
  long *in_FS_OFFSET;
  
  if ((param_2 != 0) && ((*(byte *)(param_2 + 7) & 0x40) == 0)) {
    system::rawDealloc(*in_FS_OFFSET + -0x3300);
    return;
  }
  return;
}
...
void * Nim::system::realloc0Impl(void *param_1,long param_2,size_t param_3)
...
void * Nim::system::reallocShared0Impl(void *param_1,long param_2,size_t param_3)
...

{
  ...
  pauVar1 = (undefined1 (*) [16])Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300,0x50);
  ...
  *(NimStringDesc18 **)pauVar1[3] = &Nim::ns_over__or_underflow;
  ...
  *(char **)(lVar2 + 0x18) = "fatal.nim";
  Nim::system::raiseExceptionAux(pauVar1 + 1);
  return;
}



ulong Nim::system::align(ulong param_1,long param_2)
...
void Nim::system::unregisterCycle(long param_1)
...
undefined1  [16] Nim::system::pop(long *param_1)
...
void Nim::system::scanBlack(ulong *param_1,long param_2,long *param_3)
...

{
  ...
  Nim::system::rawDealloc(*in_FS_OFFSET + -0x3300,param_1);
  return;
}



void Nim::system::scan(ulong *param_1,long param_2,long *param_3)

{
  ...
  if (((uint)uVar1 & 3) == 1) {
    if (-1 < (long)uVar1) {
      scanBlack(param_1,param_2,param_3);
      return;
    }
    *param_1 = uVar1 & 0xfffffffffffffffc | 2;
    ...
    while (*(char *)(in_FS_OFFSET + -0x60) == '\0') {
      while( true ) {
        ...
        scanBlack(lVar4 + -0x10,lVar3,param_3);
        if (*(char *)(in_FS_OFFSET + -0x60) != '\0') {
          return;
        }
      }
...

{
  ...
  Nim::system::rawDealloc(*in_FS_OFFSET + -0x3300,puVar2);
  return;
}



void Nim::system::markGray(ulong *param_1,long param_2,long *param_3)
...

{
  ...
  *(undefined8 *)(pauVar1[2] + 8) = 0x12;
  *(NimStringDesc18 **)pauVar1[3] = &Nim::ns_value_out_of_range;
  lVar2 = prepareSeqAddUninit(0,0,1,0x18,8);
  *(long *)pauVar1[4] = lVar2;
  *(undefined8 *)(pauVar1[3] + 8) = 1;
  *(char **)(lVar2 + 8) = "sysFatal";
...
void Nim::system::init(undefined8 *param_1,long param_2)
  ...
  *param_1 = 0;
  ...
  if (0xfc0 < lVar9) {
    ...
    *(ulong *)(lVar3 + -0xa68) = uVar10;
    UNLOCK();
    if (uVar4 != 0) {
      freeDeferredObjects(lVar3 + -0x3300,uVar4);
    }
    if (lVar9 + 0x30 < 0x3f000001) {
      lVar9 = getBigChunk();
    }
    else {
      lVar9 = getHugeChunk(lVar3 + -0x3300);
    }
  ...
  if (uVar4 == 0) {
    lVar5 = *in_FS_OFFSET;
    uVar4 = getBigChunk(lVar5 + -0x3300,0x1000);
    *(undefined8 *)(uVar4 + 0x28) = 0;
    *(undefined8 *)(uVar4 + 0x38) = 0;
    *(long *)(uVar4 + 8) = lVar9;
...
void Nim::system::collectCyclesBacon(long param_1,long param_2)

{
  ...
  while( true ) {
    ...
    markGray(*puVar3,puVar3[1],param_1);
  ...
  *(undefined8 *)(param_1 + 0x20) = 0x400;
  uVar4 = rawAlloc(lVar1 + -0x3300,0x4000);
  *(undefined8 *)(param_1 + 0x28) = uVar4;
  if (0 < in_FS_OFFSET[-8]) {
    do {
      lVar1 = *(long *)(in_FS_OFFSET[-6] + lVar9 * 0x10);
      *(undefined8 *)(lVar1 + 8) = 0;
      collectColor(lVar1,*(undefined8 *)(in_FS_OFFSET[-6] + 8 + lVar9 * 0x10),uVar8,param_1);
      if ((char)in_FS_OFFSET[-0xc] != '\0') {
        return;
      }
      lVar9 = lVar9 + 1;
    ...
    do {
      ...
      if ((pcVar2 == (code *)0x0) || ((*pcVar2)(lVar9 + 0x10), (char)in_FS_OFFSET[-0xc] == '\0')) {
        ...
        if ((lVar6 == 0) || (lVar9 = (lVar9 + 0x10) - (lVar6 + 0xfU & -lVar6), lVar6 < 0x11)) {
          rawDealloc(lVar7 + -0x3300,lVar9);
        }
        else {
          rawDealloc(lVar7 + -0x3300,lVar9 - (ulong)*(ushort *)(lVar9 + -2));
        }
      }
      lVar9 = *(long *)(param_1 + 0x18);
      lVar10 = lVar10 + 1;
...
void Nim::system::collectCycles(void)

{
  ...
  local_68 = rawAlloc(lVar1,0x4000);
  collectCyclesBacon(local_78,0);
  if ((char)in_FS_OFFSET[-0xc] == '\0') {
    if (local_68 != 0) {
      rawDealloc(lVar1);
      local_68 = 0;
...
void Nim::system::registerCycle(long param_1,undefined8 param_2)

{
  ...
  *(long *)(param_1 + 8) = lVar3 + 1;
  ...
  if (__src == (void *)0x0) {
    ...
    __src = (void *)rawAlloc(*in_FS_OFFSET + -0x3300,0x4000);
    lVar3 = in_FS_OFFSET[-8];
      ...
      if (SEXT816((long)sVar4) == SEXT816(lVar2) * SEXT816(0x10)) {
        if ((long)sVar4 < 0) {
          ...
          if (sVar4 == 0) {
            if (__src != (void *)0x0) {
              __dest = (void *)0x0;
              rawDealloc(*in_FS_OFFSET + -0x3300,__src);
              lVar3 = in_FS_OFFSET[-8];
            }
          }
          else {
            lVar3 = *in_FS_OFFSET;
            __dest = (void *)rawAlloc(lVar3 + -0x3300,sVar4);
            if (__src != (void *)0x0) {
...
void Nim::system::rememberCycle(char param_1,ulong *param_2,long param_3)
...
void Nim::std::typedthreads::_copy(long *param_1,long param_2)

{
  ...
  *param_1 = param_2;
  ...
  if (0xf < uVar2) {
    ...
    puVar1[-2] = uVar2 - 0x10;
    system::rememberCycle(0,puVar5,*puVar1);
    return;
  }
  system::rememberCycle(1,puVar5,*puVar1);
  ...
  if ((lVar3 != 0) &&
    ...
    system::rawDealloc(*in_FS_OFFSET + -0x3300,(long)puVar5 - (ulong)*(ushort *)((long)puVar5 + -2))
    ;
    return;
  }
  system::rawDealloc(*in_FS_OFFSET + -0x3300,puVar5);
  return;
}



void Nim::std::typedthreads::_sink(long *param_1,long param_2)
...
void Nim::system::raiseExceptionAux(long param_1)

{
  ...
  if ((((code *)in_FS_OFFSET[-0xb] == (code *)0x0) ||
    ...
    std::typedthreads::_copy(param_1 + 0x38,in_FS_OFFSET[-3],1);
    ...
    if (puVar1 != (undefined8 *)0x0) {
      ...
      if (uVar2 < 0x10) {
        ...
        if ((lVar4 == 0) ||
          ...
          rawDealloc(*in_FS_OFFSET + -0x3300,puVar6);
        }
        else {
          rawDealloc(*in_FS_OFFSET + -0x3300,(long)puVar6 - (ulong)*(ushort *)((long)puVar6 + -2));
        }
      }
      else {
        if (!SBORROW8(uVar2,0x10)) {
          puVar1[-2] = uVar2 - 0x10;
          rememberCycle(0,puVar6,*puVar1);
...

{
  ...
  auVar10 = Nim::system::dollars::_();
  lVar7 = auVar10._8_8_;
  __n = auVar10._0_8_;
  if ((char)in_FS_OFFSET[-0xc] != '\0') {
    return;
  }
  auVar10 = Nim::system::dollars::_(param_2);
  lVar8 = auVar10._8_8_;
  __n_00 = auVar10._0_8_;
  if ((char)in_FS_OFFSET[-0xc] != '\0') {
    return;
  }
  auVar10 = Nim::system::dollars::_(param_3);
  lVar9 = auVar10._8_8_;
...
LAB_00108bf1:
    ...
    local_58 = *in_FS_OFFSET;
    plVar3 = (long *)Nim::system::rawAlloc(local_58 + -0x3300,lVar2);
...
LAB_00108a26:
  ...
  *__dest_00 = 0x202e2e20;
  ...
  pauVar4 = (undefined1 (*) [16])Nim::system::rawAlloc(local_58 + -0x3300,0x50);
...
LAB_00108b6b:
    ...
    *puVar5 = (ulong)"sysFatal";
    ...
    Nim::system::raiseExceptionAux(pauVar4 + 1);
...
joined_r0x00108c80:
  if ((bVar1 & 0x40) == 0) {
    Nim::system::rawDealloc(local_58 + -0x3300,plVar3);
  }
  if ((lVar9 != 0) && ((*(byte *)(lVar9 + 7) & 0x40) == 0)) {
    Nim::system::rawDealloc(local_58 + -0x3300,lVar9);
  }
  if ((lVar8 != 0) && ((*(byte *)(lVar8 + 7) & 0x40) == 0)) {
    Nim::system::rawDealloc(local_58 + -0x3300,lVar8);
  }
  if ((lVar7 != 0) && ((*(byte *)(lVar7 + 7) & 0x40) == 0)) {
    Nim::system::rawDealloc(local_58 + -0x3300,lVar7);
    return;
  }
  return;
}
...
void * Nim::system::alignedAlloc0(size_t param_1,long param_2)

{
  ...
  if (param_2 < 0x11) {
    pvVar1 = (void *)rawAlloc(*in_FS_OFFSET + -0x3300);
...
void Nim::system::resize(long param_1)
  ...
  if (SEXT816((long)sVar3) == SEXT816(lVar2) * SEXT816(0x10)) {
    if (-1 < (long)sVar3) {
      ...
      if (sVar3 == 0) {
        ...
        lVar1 = *in_FS_OFFSET;
        __dest = (void *)rawAlloc(lVar1 + -0x3300,sVar3);
        if (__src != (void *)0x0) {
          __n = *(size_t *)(((ulong)__src & 0xfffffffffffff000) + 8);
          if (0xfc0 < (long)__n) {
            __n = __n - 0x30;
...
LAB_001090fd:
    ...
    plVar2 = (long *)Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300,__n,0x7fffffffffffffff);
...
long Nim::system::alignedAlloc(long param_1,long param_2)

{
  ...
  if (param_2 < 0x11) {
    lVar2 = rawAlloc(*in_FS_OFFSET + -0x3300,param_1);
    return lVar2;
  }
  lVar2 = param_1 + param_2;
  if (((SCARRY8(param_1,param_2)) || (SBORROW8(lVar2,1))) ||
    ...
    if (-1 < lVar3) {
      uVar1 = rawAlloc(*in_FS_OFFSET + -0x3300,lVar3);
...
void * Nim::system::alignedRealloc(void *param_1,size_t param_2,size_t param_3,long param_4)

{
  ...
  if (param_4 < 0x11) {
    if ((long)param_3 < 1) {
      ...
      lVar1 = *in_FS_OFFSET;
      __dest = (void *)rawAlloc(lVar1 + -0x3300,param_3);
      if (param_1 != (void *)0x0) {
        __n = *(size_t *)(((ulong)param_1 & 0xfffffffffffff000) + 8);
        if (0xfc0 < (long)__n) {
          __n = __n - 0x30;
    ...
    __dest = (void *)alignedAlloc(param_3,param_4);
    memcpy(__dest,param_1,param_2);
    rawDealloc(*in_FS_OFFSET + -0x3300,(long)param_1 - (ulong)*(ushort *)((long)param_1 + -2));
  }
  return __dest;
}
  ...
  if (!SCARRY8(param_2,*param_1)) {
    ...
    if ((__src == (ulong *)0x0) || ((*__src >> 0x3e & 1) != 0)) {
      if ((!SCARRY8(sVar5,1)) && (__n = sVar5 + 9, !SCARRY8(sVar5 + 1,8))) {
        if (-1 < (long)__n) {
          psVar3 = (size_t *)Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300,__n,0x7fffffffffffffff);
      ...
      if ((!SCARRY8(sVar7,1)) && (__n = sVar7 + 9, !SCARRY8(sVar7 + 1,8))) {
        if (-1 < (long)__n) {
          if (__n == 0) {
            if (__src != (ulong *)0x0) {
              Nim::system::rawDealloc(*in_FS_OFFSET + -0x3300,__src);
            }
            param_1[1] = 0;
            _DAT_00000000 = 0;
                    // WARNING: Does not return
          ...
          lVar1 = *in_FS_OFFSET;
          psVar3 = (size_t *)Nim::system::rawAlloc(lVar1 + -0x3300);
          if (__src != (ulong *)0x0) {
            ...
            Nim::system::rawDealloc(lVar1 + -0x3300);
          }
          param_1[1] = (size_t)psVar3;
          *psVar3 = sVar7;
          if ((long)sVar6 <= (long)sVar5) {
...

{
  ...
  if (0 < param_1) {
    if ((SCARRY8(param_1,1)) || (lVar1 = param_1 + 9, SCARRY8(param_1 + 1,8))) {
      ...
      if (-1 < lVar1) {
        plVar2 = (long *)Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300,lVar1);
        *plVar2 = param_1;
...
LAB_001097bc:
      ...
      psVar3 = (size_t *)Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300);
      param_1[1] = (size_t)psVar3;
      *psVar3 = param_2;
      __n_00 = *param_1;
      if ((long)__n_00 < 1) {
...
LAB_00109ae0:
    ...
    if (0x10 < param_2) {
      ...
      if (((!SCARRY8(sVar2,param_2)) && (!SBORROW8(lVar3,1))) &&
        ...
        if (-1 < (long)sVar2) {
          pvVar1 = (void *)Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300);
...
void Nim::system::collectColor(ulong *param_1,long param_2,ulong param_3,long *param_4)
          ...
          if (SEXT816((long)sVar9) == SEXT816(lVar6) * SEXT816(0x10)) {
            if ((long)sVar9 < 0) {
              ...
              if (sVar9 == 0) {
                ...
                lVar2 = *in_FS_OFFSET;
                __dest = (void *)rawAlloc(lVar2 + -0x3300);
                if (__src == (void *)0x0) {
                  lVar8 = param_4[3];
                }
                else {
    ...
    if (0x10 < param_3) {
      ...
      if (!SCARRY8(lVar2,param_3)) {
        ...
        if (!SCARRY8(lVar5 + -1,2)) {
          ...
          uVar3 = Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300,lVar2);
...
LAB_001011f0:
  ...
  plVar4 = (long *)Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300,lVar2);
LAB_00109f29:
  *plVar4 = param_1;
  return plVar4;
}
      ...
      if ((*param_2 & 0x4000000000000000) == 0) {
        ...
        if (((SEXT816(lVar5) == SEXT816((long)uVar3) * SEXT816(param_4)) &&
          ...
          if (-1 < param_5) {
            if (param_5 < 0x11) {
              if (sVar8 == 0) {
                Nim::system::rawDealloc(*in_FS_OFFSET + -0x3300,param_2);
                _DAT_00000000 = 0;
                    // WARNING: Does not return
                pcVar1 = (code *)invalidInstructionException();
                (*pcVar1)();
              ...
              lVar5 = *in_FS_OFFSET;
              puVar2 = (ulong *)Nim::system::rawAlloc(lVar5 + -0x3300,sVar8);
              ...
              Nim::system::rawDealloc(lVar5 + -0x3300,param_2);
            }
            else {
              puVar2 = (ulong *)Nim::system::alignedAlloc(sVar8,param_5);
              memcpy(puVar2,param_2,sVar7);
              Nim::system::rawDealloc
                        (*in_FS_OFFSET + -0x3300,
...
LAB_0010a1e8:
        ...
        if ((SEXT816(lVar5) == SEXT816(param_4) * SEXT816((long)uVar4)) &&
          ...
          puVar2 = (ulong *)Nim::system::alignedAlloc(lVar6,param_5);
...

{
  ...
  size_t __n;
  size_t __n_00;
  NimStringDesc43 *pNVar5;
  char *__dest;
  long lVar6;
  long lVar7;
  long lVar8;
  long lVar9;
  NimStringDesc43 *pNVar10;
  NimStringDesc43 *pNVar11;
  long *in_FS_OFFSET;
  ...
  if (param_2 < 0) {
    lVar8 = 0x2b;
    pNVar5 = (NimStringDesc43 *)0x0;
    lVar9 = *in_FS_OFFSET;
    pNVar10 = &Nim::ns_index_out_of_bounds__the_container_is_empty;
    pNVar11 = &Nim::ns_index_out_of_bounds__the_container_is_empty;
  }
  else {
    auVar12 = Nim::system::dollars::_();
    lVar6 = auVar12._8_8_;
    __n = auVar12._0_8_;
    if ((char)in_FS_OFFSET[-0xc] != '\0') {
      return;
    }
    auVar12 = Nim::system::dollars::_(param_2);
    lVar7 = auVar12._8_8_;
    __n_00 = auVar12._0_8_;
    if ((char)in_FS_OFFSET[-0xc] != '\0') {
      return;
    }
    TVar1 = (TGenericSeq)(__n + 0x13 + __n_00);
    local_48 = (undefined1  [16])0x0;
    if ((long)TVar1 < 1) {
LAB_0010a61d:
      lVar9 = *in_FS_OFFSET;
      ...
      if ((SCARRY8((long)TVar1,1)) || (lVar8 = (long)TVar1 + 9, SCARRY8((long)TVar1 + 1,8))) {
        raiseOverflow();
        goto LAB_0010a61d;
      }
      if (lVar8 < 0) {
      ...
      lVar9 = *in_FS_OFFSET;
      pNVar5 = (NimStringDesc43 *)Nim::system::rawAlloc(lVar9 + -0x3300,lVar8);
      pNVar5->data[0] = '\0';
      pNVar5->Sup = TVar1;
    }
    builtin_strncpy(pNVar5->data,"index ",7);
    __dest = pNVar5->data + 6;
    if ((long)__n < 1) {
LAB_0010a63f:
      builtin_strncpy(pNVar5->data + 6," not in ",8);
      builtin_strncpy(__dest + 5,"in 0 .. ",8);
      lVar2 = 0x13;
LAB_0010a575:
      lVar8 = lVar2;
      pNVar5->data[lVar8] = '\0';
      ...
      __dest = (char *)memcpy(__dest,(void *)(lVar6 + 8),__n);
      lVar8 = __n + 6;
      if (SCARRY8(__n,6)) {
        raiseOverflow();
        goto LAB_0010a63f;
      }
      builtin_strncpy(pNVar5->data + __n + 6," not in 0 .. ",0xd);
      lVar2 = __n + 0x13;
      if (!SCARRY8(lVar8,0xd)) goto LAB_0010a575;
      raiseOverflow();
    }
    if (0 < (long)__n_00) {
      memcpy(pNVar5->data + lVar8,(void *)(lVar7 + 8),__n_00);
      if (SCARRY8(__n_00,lVar8)) {
        raiseOverflow();
      }
      else {
        pNVar5->data[__n_00 + lVar8] = '\0';
        lVar8 = __n_00 + lVar8;
      }
    }
    if ((lVar7 != 0) && ((*(byte *)(lVar7 + 7) & 0x40) == 0)) {
      Nim::system::rawDealloc(lVar9 + -0x3300,lVar7);
    }
    if ((lVar6 != 0) && ((*(byte *)(lVar6 + 7) & 0x40) == 0)) {
      Nim::system::rawDealloc(lVar9 + -0x3300,lVar6);
    }
    pNVar10 = (NimStringDesc43 *)0x0;
    pNVar11 = pNVar5;
  }
  pauVar3 = (undefined1 (*) [16])Nim::system::rawAlloc(lVar9 + -0x3300,0x50);
  pauVar3[1] = (undefined1  [16])0x0;
  *(undefined1 **)pauVar3[1] = NTIv2__AZEPCycOV30yR2LweMemkg_;
  *pauVar3 = (undefined1  [16])0x0;
  pauVar3[2] = (undefined1  [16])0x0;
  pauVar3[3] = (undefined1  [16])0x0;
  pauVar3[4] = (undefined1  [16])0x0;
  *(char **)pauVar3[2] = "IndexDefect";
  local_48 = ZEXT816(0);
  nimAsgnStrV2(local_48,lVar8,pNVar11);
  lVar6 = *(long *)pauVar3[2];
  *(undefined8 *)(pauVar3[2] + 8) = local_48._0_8_;
  *(undefined8 *)pauVar3[3] = local_48._8_8_;
  if (lVar6 == 0) {
    *(char **)pauVar3[2] = "IndexDefect";
  }
  puVar4 = *(ulong **)pauVar3[4];
  lVar6 = *(long *)(pauVar3[3] + 8);
  if (puVar4 == (ulong *)0x0) {
    puVar4 = (ulong *)prepareSeqAddUninit(lVar6,0,1,0x18,8);
    *(ulong **)pauVar3[4] = puVar4;
...
LAB_0010a60e:
    ...
    if ((long)(*puVar4 & 0xbfffffffffffffff) < lVar6 + 1) {
      puVar4 = (ulong *)prepareSeqAddUninit(lVar6,puVar4,1,0x18,8);
      *(ulong **)pauVar3[4] = puVar4;
    }
  }
  *(long *)(pauVar3[3] + 8) = lVar6 + 1;
  puVar4 = puVar4 + lVar6 * 3 + 1;
  *puVar4 = (ulong)"sysFatal";
  puVar4[1] = 0x35;
  puVar4[2] = (ulong)"fatal.nim";
LAB_0010a3d5:
  Nim::system::raiseExceptionAux(pauVar3 + 1);
  if ((pNVar5 != (NimStringDesc43 *)0x0) && (((pNVar5->Sup).reserved & 0x40000000) == 0)) {
    Nim::system::rawDealloc(lVar9 + -0x3300,pNVar5);
  }
  if ((pNVar10 != (NimStringDesc43 *)0x0) && (((pNVar10->Sup).reserved & 0x40000000) == 0)) {
    Nim::system::rawDealloc(lVar9 + -0x3300,pNVar10);
    return;
  }
  return;
}
...
LAB_0010a75b:
  if ((((code *)in_FS_OFFSET[-0xb] == (code *)0x0) ||
     ...
     ((globalRaiseHook__system_u3681 == (code *)0x0 ||
      (cVar3 = (*globalRaiseHook__system_u3681)(param_1), cVar3 != '\0')))) {
    Nim::std::typedthreads::_copy(param_1 + 0x38,in_FS_OFFSET[-3],1);
    puVar1 = (undefined8 *)in_FS_OFFSET[-3];
    in_FS_OFFSET[-3] = param_1;
    if (puVar1 != (undefined8 *)0x0) {
      uVar2 = puVar1[-2];
      puVar7 = puVar1 + -2;
      if (uVar2 < 0x10) {
        Nim::system::rememberCycle(1,puVar7,*puVar1);
        puVar5 = (undefined8 *)*puVar1;
        if ((code *)*puVar5 != (code *)0x0) {
          (*(code *)*puVar5)(puVar1);
          puVar5 = (undefined8 *)*puVar1;
        ...
        if ((lVar4 == 0) ||
          ...
          Nim::system::rawDealloc(*in_FS_OFFSET + -0x3300,puVar7);
        }
        else {
          Nim::system::rawDealloc
        ...
        if (!SBORROW8(uVar2,0x10)) {
          puVar1[-2] = uVar2 - 0x10;
          Nim::system::rememberCycle(0,puVar7,*puVar1);
          *(undefined1 *)(in_FS_OFFSET + -0xc) = 1;
          return;
        }
        raiseOverflow();
...
undefined1  [16] Nim::system::_dup(long param_1,long *param_2)

{
  ...
  if ((param_2 != (long *)0x0) && ((*param_2 & 0x4000000000000000) == 0)) {
    ...
    if ((SCARRY8(param_1,1)) || (lVar1 = param_1 + 9, SCARRY8(__n,8))) {
      ...
      if (-1 < lVar1) {
        plVar2 = (long *)rawAlloc(*in_FS_OFFSET + -0x3300,lVar1);
        *plVar2 = param_1;
        if ((long)__n < 0) {
          raiseRangeErrorI(__n,0,0x7fffffffffffffff);
        }
...
void Nim::system::add(ulong *param_1)

{
  ...
  if (__src == (ulong *)0x0) {
    ...
    if (!SCARRY8(lVar4,8)) {
      ...
      __dest = (ulong *)rawAlloc(*in_FS_OFFSET + -0x3300,lVar5);
      *__dest = uVar9;
      goto LAB_0010ab74;
    }
    goto LAB_0010acb6;
...
LAB_0010ac60:
        ...
        lVar4 = *in_FS_OFFSET;
        __dest = (ulong *)rawAlloc(lVar4 + -0x3300,sVar6);
...

{
  ...
  if (0 < param_2) {
    ...
    if ((SCARRY8(param_2,1)) || (lVar2 = param_2 + 9, SCARRY8(__n,8))) {
      ...
      plVar1 = (long *)Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300,lVar2);
      *plVar1 = param_2;
      if (-1 < (long)__n) {
  ...
  if (param_1 != (size_t *)0x0) {
    ...
    if (sVar1 != 0) {
      ...
      if (((long)uVar3 < 0) || (uVar3 < sVar1 + 1)) {
        ...
        if (-1 < (long)uVar3) {
          psVar2 = (size_t *)Nim::system::rawAlloc(*in_FS_OFFSET + -0x3300,uVar3);
          *psVar2 = sVar1;
...
void Nim::system::add(size_t *param_1,char *param_2)
...
LAB_0010b0b0:
      ...
      if ((__src == (ulong *)0x0) || ((*__src & 0x4000000000000000) != 0)) {
        ...
        if ((long)(sVar8 + 10) < 0) {
          ...
          psVar3 = (size_t *)rawAlloc(*in_FS_OFFSET + -0x3300);
          param_1[1] = (size_t)psVar3;
          *psVar3 = sVar10;
          sVar8 = *param_1;
          if ((long)sVar8 < 1) {
        ...
        if ((long)uVar5 < (long)sVar10) {
          ...
          if ((long)sVar6 < 0) {
            ...
            lVar1 = *in_FS_OFFSET;
            psVar3 = (size_t *)rawAlloc(lVar1 + -0x3300);
            if (__src != (ulong *)0x0) {
              __n = *(size_t *)(((ulong)__src & 0xfffffffffffff000) + 8);
              if (0xfc0 < (long)__n) {
                __n = __n - 0x30;
...
undefined1  [16] Nim::system::_(long param_1,long param_2)

{
  ...
  local_40 = (ulong *)rawAlloc(*in_FS_OFFSET + -0x3300,0x7d9);
  *local_40 = 2000;
...
LAB_0010b284:
      ...
      if (0 < lVar14) {
        ...
        *(undefined1 *)((long)local_40 + local_48 + 8) = 0x28;
        ...
        std::private::digitsutils::addInt(&local_48,puVar16[1]);
        prepareAdd(&local_48,1);
          ...
          if ((local_40 == (ulong *)0x0) || ((*local_40 & 0x4000000000000000) != 0)) {
            if ((!SCARRY8(uVar7,1)) && (!SCARRY8(local_48 + 2,8))) {
              if ((long)(local_48 + 10) < 0) {
                ...
                local_40 = (ulong *)rawAlloc(lVar2 + -0x3300);
                uVar10 = local_48;
                *local_40 = uVar7;
                if ((long)local_48 < 1) {
                  if (puVar6 == (ulong *)0x0) {
            ...
            if ((long)sVar12 < 0) {
              ...
              if (sVar12 == 0) {
                if (local_40 != (ulong *)0x0) {
                  rawDealloc(*in_FS_OFFSET + -0x3300,local_40);
                }
                _DAT_00000000 = 0;
                    // WARNING: Does not return
              ...
              lVar3 = *in_FS_OFFSET;
              puVar8 = (ulong *)rawAlloc(lVar3 + -0x3300);
              if (puVar6 != (ulong *)0x0) {
...
joined_r0x0010b670:
        ...
        if ((local_40 == (ulong *)0x0) || ((*local_40 & 0x4000000000000000) != 0)) {
          if ((!SCARRY8(uVar11,1)) && (!SCARRY8(local_48 + 2,8))) {
            if ((long)(local_48 + 10) < 0) {
              ...
              local_40 = (ulong *)rawAlloc(lVar14 + -0x3300);
              uVar10 = local_48;
              *local_40 = uVar11;
              if ((long)local_48 < 1) {
                if (puVar6 == (ulong *)0x0) {
        ...
        if ((long)uVar10 < (long)uVar11) {
          ...
          if ((long)sVar12 < 0) {
            ...
            lVar2 = *in_FS_OFFSET;
            puVar8 = (ulong *)rawAlloc(lVar2 + -0x3300);
            if (puVar6 != (ulong *)0x0) {
              sVar9 = *(size_t *)(((ulong)puVar6 & 0xfffffffffffff000) + 8);
              if (0xfc0 < (long)sVar9) {
                sVar9 = sVar9 - 0x30;
...
void Nim::std::typedthreads::_destroy(undefined8 *param_1)

{
  ...
  if (0xf < uVar1) {
    ...
    system::rememberCycle(0,puVar4,*param_1);
    return;
  }
  system::rememberCycle(1,puVar4,*param_1);
  ...
  if ((lVar2 != 0) &&
    ...
    system::rawDealloc(*in_FS_OFFSET + -0x3300,(long)puVar4 - (ulong)*(ushort *)((long)puVar4 + -2))
    ;
    return;
  }
  system::rawDealloc(*in_FS_OFFSET + -0x3300,puVar4);
  return;
}



void Nim::system::writeToStdErr(void *param_1,size_t param_2)
...
void Nim::system::showErrorMessage(char *param_1,size_t param_2)

{
  ...
  if (param_1 == (char *)0x0) {
    ...
    if ((lVar2 != 0) && ((*(byte *)(lVar2 + 7) & 0x40) == 0)) {
      rawDealloc(*in_FS_OFFSET + -0x3300,lVar2);
    }
  }
  if ((char)in_FS_OFFSET[-0xc] == '\0') {
    return;
  ...
  *(undefined1 *)(in_FS_OFFSET + -0xc) = 0;
  raiseDefect();
  std::typedthreads::_copy(*in_FS_OFFSET + -0x18,*(undefined8 *)(in_FS_OFFSET[-3] + 0x38),0);
  return;
}



void Nim::system::reportUnhandledErrorAux(long param_1)
...
LAB_0010bce8:
    ...
    auVar7 = _(*(undefined8 *)(param_1 + 0x28),*(undefined8 *)(param_1 + 0x30));
    lVar3 = auVar7._8_8_;
    sVar4 = auVar7._0_8_;
    if ((1999 < (long)sVar4) || (sVar4 == 0)) {
      if ((lVar3 != 0) && ((*(byte *)(lVar3 + 7) & 0x40) == 0)) {
        rawDealloc(*in_FS_OFFSET + -0x3300,lVar3);
      }
      goto LAB_0010bce0;
    }
...
LAB_0010bd6b:
  ...
  showErrorMessage(local_808,sVar4);
  return;
}



void Nim::system::reportUnhandledError(undefined8 param_1)

{
  if (unhandledExceptionHook__system_u3689 != (code *)0x0) {
    (*unhandledExceptionHook__system_u3689)();
  }
  reportUnhandledErrorAux(param_1);
  return;
}
...

{
  ...
  if ((1 < *(short *)(*plVar1 + 0x12)) && (*(int *)(*(long *)(*plVar1 + 0x18) + 8) == -0x49fa4800))
  {
    ...
    Nim::system::reportUnhandledErrorAux(plVar1);
                    // WARNING: Subroutine does not return
    exit(1);
  }
  uVar2 = plVar1[-2];
  if (0xf < uVar2) {
    ...
    plVar1[-2] = uVar2 - 0x10;
    Nim::system::rememberCycle(0,plVar5,*plVar1);
    return;
  }
  Nim::system::rememberCycle(1,plVar5);
  ...
  Nim::system::rawDealloc(*in_FS_OFFSET + -0x3300,plVar5);
  return;
}
...

{
  ...
  Nim::system::showErrorMessage(pcVar1);
...
void Nim::system::registerSignalHandler(void)
...
undefined1  [16] Nim::system::newStringUninit(long param_1)
...
void Nim::system::nimPrepareStrMutationImpl(long *param_1)

{
  ...
  lVar1 = param_1[1];
  plVar3 = (long *)rawAlloc(*in_FS_OFFSET + -0x3300,lVar2);
  lVar2 = *param_1;
...
undefined1  [16] Nim::system::substr(long param_1,long param_2,long param_3,long param_4)
...
LAB_0010c6c8:
      ...
      if (lVar9 < 0) {
        ...
        plVar4 = (long *)rawAlloc(*in_FS_OFFSET + -0x3300,lVar9);
        *plVar4 = local_70;
        ...
        do {
          if ((*plVar4 & 0x4000000000000000) != 0) {
            if (bVar2) {
              ...
              plVar5 = (long *)rawAlloc(*in_FS_OFFSET + -0x3300,lVar9);
              *plVar5 = local_70;
...
void Nim::pokerod::shrink(undefined8 *param_1,undefined8 param_2)
...
void Nim::pokerod::setLen(long *param_1,long param_2)
...
void Nim::pokerod::newSeq(long *param_1,long param_2)
...
undefined1  [16] Nim::pokerod::newSeq(size_t param_1)
...
void Nim::pokerod::_destroy(undefined8 param_1,long param_2)
...
undefined8 Nim::pokerod::__(long param_1,long param_2,long param_3,long param_4)
...

{
  ...
  if (((char)in_FS_OFFSET[-0xc] != '\0') && (lVar1 = in_FS_OFFSET[-3], lVar1 != 0)) {
    ...
    Nim::system::reportUnhandledErrorAux(lVar1);
    Nim::std::typedthreads::_sink(*in_FS_OFFSET + -0x18,0);
                    // WARNING: Subroutine does not return
    exit(1);
  }
  return;
...
void Nim::..::..::..::..::..::.choosenim::toolchains::nim-2.2.4::lib::system::Init000(void)

{
  ...
  if (((char)in_FS_OFFSET[-0xc] != '\0') && (lVar1 = in_FS_OFFSET[-3], lVar1 != 0)) {
    ...
    Nim::system::reportUnhandledErrorAux(lVar1);
    std::typedthreads::_sink(*in_FS_OFFSET + -0x18,0);
                    // WARNING: Subroutine does not return
    exit(1);
  }
  return;
...

{
  ...
  uVar2 = Nim::system::substr(param_1,param_2,lVar4);
  return uVar2;
}



undefined1  [16] Nim::pokerod::keystream(int param_1,long param_2)
...
undefined1  [16] Nim::pokerod::xorEncrypt(long param_1,long param_2,int param_3)
...

{
  ...
  uVar2 = std::syncio::readLine(stdin);
  if (*(char *)(in_FS_OFFSET + -0x60) == '\0') {
    uVar6 = 0;
    uVar5 = 0;
    uVar2 = nsuStrip(uVar2,extraout_RDX,1,1,TM__xrbkmOY9b1OBM0sYlMZSA0g_4);
    if ((*(char *)(in_FS_OFFSET + -0x60) == '\0') &&
       (uVar6 = xorEncrypt(uVar2,extraout_RDX_00,0x14471187), uVar5 = extraout_RDX_01,
       *(char *)(in_FS_OFFSET + -0x60) == '\0')) {
      cVar4 = __(uVar6,extraout_RDX_01,0x20,TM__xrbkmOY9b1OBM0sYlMZSA0g_7);
      if (cVar4 == '\0') {
...
void Nim::..::..::..::..::..::.choosenim::toolchains::nim-2.2.4::lib::system::PreMain(void)
...
{
  ..::..::..::..::..::.choosenim::toolchains::nim-2.2.4::lib::system::Init000();
  pokerod::main();
  nimTestErrorFlag();
  return;
}
